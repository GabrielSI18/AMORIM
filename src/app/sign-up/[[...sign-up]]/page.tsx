          ...
          <div className="w-full max-w-sm flex flex-col items-center gap-6">
            ...
            <form onSubmit={handleVerify} className="w-full flex flex-col gap-4">
              <label className="flex flex-col w-full">
                <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-8">
        <div className="w-full max-w-sm flex flex-col items-center gap-5">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            {/* Nome */}
            <label className="flex flex-col w-full">
              <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">Nome Completo</p>
              <input
                type="text"
                value={fullName}
            ...
            {/* Email */}
            <label className="flex flex-col w-full">
              <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">E-mail</p>
              <input
                type="email"
                value={emailAddress}
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="flex flex-col w-full">
                <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">CPF</p>
                <input
                  type="text"
                  value={cpf}
              ...
              <label className="flex flex-col w-full">
                <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">Telefone</p>
                <input
                  type="tel"
                  value={phone}
            ...
            {/* Data de Nascimento */}
            <label className="flex flex-col w-full">
              <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">Data de Nascimento</p>
              <input
                type="date"
                value={birthDate}
                onChange={(e) => setBirthDate(e.target.value)}
                className="w-full h-14 px-4 rounded-lg border border-[#e0e0e0] dark:border-[#324467] bg-white dark:bg-[#192233] text-[#333333] dark:text-white focus:outline-none focus:border-[#003c71] dark:focus:border-[#0A3A66] focus:ring-2 focus:ring-[#003c71]/20 dark:focus:ring-[#0A3A66]/50 transition-all"
              />
            </label>

            {/* Senha */}
            <label className="flex flex-col w-full">
              <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">Senha</p>
            ...
            {/* Confirmar Senha */}
            <label className="flex flex-col w-full">
              <p className="text-[#333333] dark:text-white text-sm font-medium pb-2">Confirmar Senha</p>
              <div className="flex w-full items-stretch">
                <input
            ...
            {error && <p className="text-[#dc143c] text-sm font-medium">{error}</p>}

            {/* Botão Submit */}
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-14 rounded-lg bg-[#D92E2E] dark:bg-[#dc2626] text-white font-bold text-base shadow-sm hover:bg-[#D92E2E]/90 dark:hover:bg-[#b91c1c] focus:outline-none focus:ring-2 focus:ring-[#D92E2E] dark:focus:ring-[#dc2626] focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="w-full text-center">
            <p className="text-[#969696] dark:text-[#92a4c9] text-sm">
              Já tem uma conta?{' '}
              <a href="/sign-in" className="font-bold text-[#003c71] dark:text-[#0A3A66] hover:underline">
                Faça login
              </a>
            </p>
          </div>
